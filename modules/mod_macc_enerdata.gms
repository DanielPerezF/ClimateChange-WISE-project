...
* Abatement costs
    ...
    ABATECOST_OGHG    'Cost of oghg emissions reductions [Trill 2005 USD / year]'
* CPrices
...
** OGHG ABATECOSTS
$ifthen.oghg %climate% == 'witchoghg'
loop( (sector,oghg)$map_sector_ghg(sector,oghg),

                                  # Powerfit Abatement Cost:  [ USD/tCO2eq_max_abat ] :  a (MIU^(b+1)) / (b+1)
   ABATECOST_OGHG.l(oghg,t,n)  =  ED_a_oghg(sector,t,n)*(MIU_OGHG.l(oghg,t,n)**(ED_b_oghg(sector,t,n) +1)) / (ED_b_oghg(sector,t,n) +1)
                                  # Baseline emissions   [ GtCo2eq ]
                               *  oghg_emi_bau(oghg,t,n)
                                  # Coversion result     [ G USD /1000 -> Trill USD ]
                               /  1000   ;
);
$endif.oghg
